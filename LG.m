...
(*Amplitude-> 0.5, AmplitudeOffset-> 0, Frequency-> 1,PhaseOffset-> 0,*)
(*Size->{None, None}, Start-> {0,0},PhaseFullCycle-> True,Clamped-> False,*)
(*Raw-> False*)
...
(*ang =N[angle];*)
(*fc=If[OptionValue[PhaseFullCycle], 1, 0];*)
(*cl= If[OptionValue[Clamped], 1, 0];*)
(**)
(*bytes=Check[Blaze[ang,scale,offset,amp, ampOffset,x,y,w,h,fc,cl,data],Abort[]];*)
(**)
